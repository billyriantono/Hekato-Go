...
func (h *Handler) handleAdminAPI(w http.ResponseWriter, r *http.Request) {
	...
	case path == "/auth/codebuddy" && r.Method == "POST":
		h.apiImportCodeBuddy(w, r)
...
func (h *Handler) apiStartGrokAuth(w http.ResponseWriter, r *http.Request) {
...
// completed=true.
func (h *Handler) apiPollGrokAuth(w http.ResponseWriter, r *http.Request) {
	var req struct {
		SessionID string `json:"sessionId"`
	}
	if err := json.NewDecoder(r.Body).Decode(&req); err != nil {
...
func (h *Handler) apiImportCodeBuddy(w http.ResponseWriter, r *http.Request) {
	var req struct {
...
func (h *Handler) apiImportGrok(w http.ResponseWriter, r *http.Request) {
